...
export const heroCards = [
  {
    ...
    subtitle: "Explore the POST /v1/messages request and inspect its response shape.",
    alt: "SendAfrica API Playground example with a POST /v1/messages request and JSON response envelope",
  },
  {
    img: "/images/sendafrica_live_message_logs.webp",
    title: "Delivery Logs",
    subtitle: "Review message status as asynchronous delivery reports arrive.",
    alt: "Illustrative SendAfrica message log with sent, delivered, and failed status examples",
  },
] as const;
...
export const analyticsCards = [
  {
    ...
    stats: ["Sent, delivered, and failed", "Recipient-level status"],
    meta: "Campaign overview",
    description: "Review audience progress as campaign results arrive.",
    alt: "Illustrative SendAfrica campaign analytics dashboard with a delivery trend chart",
  },
  {
    ...
    meta: "HMAC verified",
    description: "Verify webhook signatures before processing delivery events.",
    alt: "Illustrative SendAfrica webhook events dashboard with delivery callbacks and signature verification",
  },
  {
    img: "/images/sendafrica_credits_usage_alt.webp",
    title: "Credits & Usage",
    stats: ["Credit balance", "Message-part usage"],
    meta: "Account overview",
    description: "Follow credit usage without assuming one fixed TZS rate.",
    alt: "Illustrative SendAfrica credits and usage dashboard showing balance and usage visualization",
  },
] as const;
